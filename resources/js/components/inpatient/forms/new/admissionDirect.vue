  ...
  <div class=" row shadow-sm- p-4 mb-4 bg-white">
   <div class="col-lg-12 ">
            ...
            <form class="user" @submit.prevent="register">
              ...
              <b-form-select  v-model="form.ward"    
                required @change="getBed()" >
                     <option v-for="ward in wards" v-bind:key="ward.ward" v-bind:value="ward.id" >{{ward.ward }} </option> 
                        ...
                        <b-col>
                      <label>Katil</label>
                         <select class="form-control" id="district" v-model="bed_discipline.bedcode" required>
  ...
  export default {
     ...
     axios.get('/api/ward/'+'?token='+  localStorage.getItem('token'))
      .then(function (response) {
        self.wards = response.data;
             ...
             getBed(){
    let self = this;
     axios.get('/api/bed/ward/'+this.form.ward +'?token='+  localStorage.getItem('token'))
      .then(function (response) {
    ...
    let self = this;
     axios.get('/api/discipline'+'?token='+  localStorage.getItem('token'))
      ...
      bed_id: this.bed_discipline.bedcode,
