            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Pesakit Aktif</h6>
                </div>
...
<b-row>
<b-col>
  <h5 class="mt-3"  align="left"  v-if="!isHidden" style="color:blue" > <b>Current Active Patient:  {{ items.length }}</b></h5>
  </b-col>
  </b-row>
      ...
      patientUpdate(){
       ...
       .then(function (response) {
        self.items = response.data;
         ...
         viewModal(record) {
          let self = this;
            axios.get('/api/reports/'+record.id+ '?token='+ localStorage.getItem('token'))
  	     .then(function (response) {
