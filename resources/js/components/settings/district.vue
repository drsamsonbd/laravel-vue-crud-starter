  ...
  <!--Insert Modal-->
    ...
    <b-modal ref="category-insert-modal" hide-footer title="Tetapan">
            ...
            <form class="user" @submit.prevent="categoryInsert">
              ...
              <input type="text" class="form-control" id="exampleInputFirstName" placeholder="Sila masukkan mukim" v-model="form.district">
  ...
  <b-modal ref="update-modal" hide-footer title="Kemaskini Kod Peruntukan">     
           <form class="user" @submit.prevent="categoryUpdate">
               <b-row>
                <b-col>
                  <label for=""><b>Daerah</b></label>
              <input type="text" class="form-control" id="exampleInputFirstName" placeholder="Sila masukkan mukim" v-model="forms.district">
              <small class="text-danger" v-if="errors.district"> {{ errors.district[0] }} </small>   
                </b-col>
            </b-row>
            <br>
...
<b-row>
   <div class="col">
    ...
    <b-col class="shadow-sm  bg-white">
           <caption><h5><b>Daerah</b></h5></caption>  
...
//category
        ...
        categoryitems: [],
        categoryfields: [
          { key: 'district', label: 'Daerah', sortable: true, sortDirection: 'asc' },
...
// show insert modal
 ...
 //update       
     categoryUpdate(){
       ...
       axios.patch('/api/district/'+id,this.forms)
       .then(() => { 
