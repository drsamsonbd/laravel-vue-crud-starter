  ...
  <!--Insert Modal-->
    ...
    <b-modal ref="category-insert-modal" hide-footer title="Tetapan">
            ...
            <form class="user" @submit.prevent="categoryInsert">
              <b-row>
                <b-col>
                  <label for=""><b>Bangsa</b></label>
              <input type="text" class="form-control" id="exampleInputFirstName" placeholder="Sila masukkan mukim" v-model="form.race">
  ...
  <b-modal ref="update-modal" hide-footer title="Kemaskini Kod Peruntukan">     
           <form class="user" @submit.prevent="categoryUpdate">
               <b-row>
                <b-col>
                  <label for=""><b>Bangsa</b></label>
              <input type="text" class="form-control" id="exampleInputFirstName" placeholder="Sila masukkan mukim" v-model="forms.race">
              <small class="text-danger" v-if="errors.race"> {{ errors.race[0] }} </small>   
                </b-col>
            </b-row>
            <br>
...
<b-row>
   <div class="col">
    ...
    <b-col class="shadow-sm  bg-white">
           <caption><h5><b>Bangsa</b></h5></caption>  
...
// show insert modal
 ...
 //update       
     categoryUpdate(){
       ...
       axios.patch('/api/race/'+id,this.forms)
       .then(() => { 
