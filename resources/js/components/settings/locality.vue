  ...
  <!--Insert Modal-->
    ...
    <b-modal ref="category-insert-modal" hide-footer title="Tetapan">
            ...
            <form class="user" @submit.prevent="categoryInsert">
              <b-row>
                <b-col>
                  <label for=""><b>Lokaliti</b></label>
              <input type="text" class="form-control" id="exampleInputFirstName" placeholder="Sila masukkan mukim" v-model="form.locality">
              <small class="text-danger" v-if="errors.locality"> {{ errors.locality[0] }} </small>   
                </b-col>
            </b-row>
                      <br>
            <b-row>
  ...
  <b-modal ref="update-modal" hide-footer title="Kemaskini Kod Peruntukan">     
           <form class="user" @submit.prevent="categoryUpdate">
               <b-row>
                <b-col>
                  <label for=""><b>Lokaliti</b></label>
              <input type="text" class="form-control" id="exampleInputFirstName" placeholder="Sila masukkan mukim" v-model="forms.locality">
              <small class="text-danger" v-if="errors.locality"> {{ errors.locality[0] }} </small>   
                </b-col>
            </b-row>
            <br>
...
<b-row>
   <div class="col">
    ...
    <b-col class="shadow-sm  bg-white">
           <caption><h5><b>Lokaliti</b></h5></caption>  
...
//category
        ...
        categoryitems: [],
        categoryfields: [
          { key: 'locality', label: 'Lokaliti', sortable: true, sortDirection: 'asc' },
...
// show insert modal
 ...
 //insert  
       categoryInsert(){
       axios.post('/api/locality',this.form)
       .then(() => { 
 ...
 //update       
     categoryUpdate(){
       ...
       axios.patch('/api/locality/'+id,this.forms)
       .then(() => { 
