  ...
  <!--Insert Modal-->
    ...
    <b-modal ref="category-insert-modal" hide-footer title="Tetapan">
            ...
            <form class="user" @submit.prevent="categoryInsert">
              ...
              <input type="text" class="form-control" id="exampleInputFirstName" placeholder="Sila masukkan mukim" v-model="form.hospital">
              <small class="text-danger" v-if="errors.hospital"> {{ errors.hospital[0] }} </small>   
                </b-col>
            </b-row>
                      <br>
            <b-row>
  ...
  <b-modal ref="update-modal" hide-footer title="Kemaskini Kod Peruntukan">     
           <form class="user" @submit.prevent="categoryUpdate">
               <b-row>
                <b-col>
                  <label for=""><b>Hospital</b></label>
              <input type="text" class="form-control" id="exampleInputFirstName" placeholder="Sila masukkan mukim" v-model="forms.hospital">
              <small class="text-danger" v-if="errors.hospital"> {{ errors.hospital[0] }} </small>   
                </b-col>
            </b-row>
            <br>
...
<b-row>
   <div class="col">
    ...
    <b-col class="shadow-sm  bg-white">
           <caption><h5><b>Hospital</b></h5></caption>  
...
//category
        ...
        categoryitems: [],
        categoryfields: [
          { key: 'hospital', label: 'Hospital', sortable: true, sortDirection: 'asc' },
...
// show insert modal
 ...
 //insert  
       categoryInsert(){
       axios.post('/api/hospital',this.form)
       .then(() => { 
 ...
 //update       
     categoryUpdate(){
       ...
       axios.patch('/api/hospital/'+id,this.forms)
       .then(() => { 
